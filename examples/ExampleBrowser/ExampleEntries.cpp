...
#include "../Collision/CollisionDemo.h"
...
static ExampleEntry gDefaultExamples[] =
    ...
    ExampleEntry(1, "Kinematic MultiBody", "Let the user set the transform, the physics engine computes the velocity for one-way contact and friction interaction.", KinematicMultiBodyExampleCreateFunc),
		...
		ExampleEntry(1, "Cube collision", "Cube collision", CubeCollisionCreateFunc),
//ExampleEntry(1, "Spheres & Plane C-API (Bullet3)", "Collision C-API using Bullet 3.x backend", CollisionTutorialBullet2CreateFunc,TUT_SPHERE_PLANE_RTB3),
		...
		ExampleEntry(1, "CableForceDown", "Add 10 cubes and 5 cables. Press A to add forces on cube down. Press D to print distance between anchor and its node", CableDemoCreateFunc, 0),
		ExampleEntry(1, "CableForceUp", "Add 10 cubes and 5 cables. Press A to add forces on cube up. Press D to print distance between anchor and its node", CableDemoCreateFunc, 1),	
		...
		ExampleEntry(1, "Test Growth Speed", " Test duration of cable growth", CableDemoCreateFunc, 17),
		ExampleEntry(1, "Test Cable CollisionMt", " Test multi threaded collisions with two cables", CableDemoCreateFunc, 18),
		ExampleEntry(1, "Test Cable Hydro", "Apply water normal force on cable", CableDemoCreateFunc, 19),
		ExampleEntry(1, "Test Cable Beding", "Cable on a cube", CableDemoCreateFunc, 20),
		ExampleEntry(1, "TwoCablesOneCube", "One cube attached by 2 cables.", CableDemoCreateFunc, 21),
		ExampleEntry(1, "Test Detach A18", "A18's detach simulation.", CableDemoCreateFunc, 22),
		ExampleEntry(1, "Test MCMV Cable", "Simulate the MCMV Cable (with collisions).", CableDemoCreateFunc, 23),
		ExampleEntry(1, "Test BallJoint", "BallJointDampingTest", CableDemoCreateFunc, 24),
		...
		ExampleEntry(1, "Test Stability Tension", "", CableDemoCreateFunc, 28),
		ExampleEntry(1, "Test Stability A18", "", CableDemoCreateFunc, 29),
		ExampleEntry(1, "Test Stability (OLD)", "", CableDemoCreateFunc, 30),
		ExampleEntry(1, "Test Benchmark Substeps", "", CableDemoCreateFunc, 31),
